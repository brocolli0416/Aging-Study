...
function SoundCheckIntroRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SoundCheckIntroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Headphone_retestLoopBegin(Headphone_retestLoopScheduler) {
  ...
  for (const thisHeadphone_retest of Headphone_retest) {
...
function RepeatAgainLoopLoopBegin(RepeatAgainLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisRepeatAgainLoop of RepeatAgainLoop) {
...
function MSTLoopLoopBegin(MSTLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMSTLoop of MSTLoop) {
...
function MSTTrainLoopLoopBegin(MSTTrainLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMSTTrainLoop of MSTTrainLoop) {
...
function MSTPlayLoopLoopBegin(MSTPlayLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisMSTPlayLoop of MSTPlayLoop) {
...
function SLLoopLoopBegin(SLLoopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSLLoop of SLLoop) {
...
function Rest_codeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of Rest_codeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function RepeatAgainRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of RepeatAgainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTWelcomeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTWelcomeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTWelcome2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTWelcome2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTTrainIntroRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTTrainIntroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTTrainRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTTrainComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTTrainFeedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTTrainFeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTTestStartInstrctRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTTestStartInstrctComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTTrialCountRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of MSTTrialCountComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function MSTplayRoutineBegin(snapshot) {
  return function () {
    ...
    MSTplayComponents.push(MST_resp);
    MSTplayComponents.push(MSTTestTrialNum);
    MSTplayComponents.push(MSTTestNote);
    
    for (const thisComponent of MSTplayComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function BreakOverRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of BreakOverComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AttentionCheck3RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AttentionCheck3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AttentionCheck1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AttentionCheck1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AttentionCheck2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of AttentionCheck2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
